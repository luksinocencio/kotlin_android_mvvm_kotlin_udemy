...
class CalcViewModelTest {
    ...
    fun setUp() {
        ...
        Mockito.`when`(calculations.calculateArea(2.1))
                .thenReturn(13.8474)
        Mockito.`when`(calculations.calculateCircumference(1.0))
                .thenReturn(6.28)
    ...
    fun calculateArea_radiusSent_updateLiveData() {
        ...
        var result = calcViewModel.areaValue.value
    ...
    fun calculateCircumference_radiusSent_updateLiveData() {
        ...
        var result = calcViewModel.circumferenceValue.value
